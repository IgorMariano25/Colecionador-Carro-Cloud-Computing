...
public class ColecionadorController {
    ...
    public ResponseEntity<List<Colecionador>> getAll() {
        try {
            return new ResponseEntity<>(this.colecionadorService.findAll(), HttpStatus.OK);
        } catch (Exception e) {
    ...
    public ResponseEntity<Colecionador> create(@Valid @RequestBody Colecionador item) {
        try {
            Colecionador result = this.colecionadorService.save(item);
    ...
    public ResponseEntity<Colecionador> getById(@PathVariable("id") Long id) {
        ...
        Optional<Colecionador> result = this.colecionadorService.findById(id);
    ...
    public ResponseEntity<Colecionador> update(@PathVariable("id") Long id,
        ...
        try {
            Colecionador result = this.colecionadorService.update(id, colecionadorNovosDados);
    ...
    public ResponseEntity<HttpStatus> delete(@PathVariable("id") Long id) {
        try {
            Optional<Colecionador> colecionadorASerExcluido = this.colecionadorService.findById(id);

            if (colecionadorASerExcluido.isPresent() == false) {
                throw new Exception("Não encontrei o colecionador a ser excluído");
            }

            this.colecionadorService.delete(colecionadorASerExcluido.get().getId());
